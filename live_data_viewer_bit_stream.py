...
class LiveDataViewer(QtWidgets.QMainWindow):
    ...
    def init__ui(self):
        ...
        self.plot_widget.setLabel('bottom', 'Range (m)')
        ...
        self.temp_text = pg.TextItem(text="Temp: --", color=(255, 100, 0), anchor=(0, 1))
        self.temp_text.setPos(0.01, Y_LIMITS[1] * .90)
        self.temp_text.size = '32pt'
        self.plot_widget.addItem(self.temp_text)
        
        self.divisor_text = pg.TextItem(text="Divisor: --", color=(0, 150, 0), anchor=(0, 1))
        self.divisor_text.setPos(0.01, Y_LIMITS[1] * .80)
        self.divisor_text.size = '32pt'
        self.plot_widget.addItem(self.divisor_text)
    ...
    def _update_plot(self):
        ...
        if metadata_updated:
            self.temp_text.setText(f"Temp: {self.current_temp}")
            self.divisor_text.setText(f"Divisor: {self.current_divisor}")
